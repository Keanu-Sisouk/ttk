...
int main(int argc, char **argv) {
  ...
  // ---------------------------------------------------------------------------
  ttk::Debug msg;
  msg.setDebugMsgPrefix("PersistenceDiagramDictDecoding");
  ...
  // ---------------------------------------------------------------------------
  // persistenceDiagramDictDecoding->SetOutputArrayName(outputArrayName);
  ...
  // ---------------------------------------------------------------------------
  persistenceDiagramDictDecoding->Update();
