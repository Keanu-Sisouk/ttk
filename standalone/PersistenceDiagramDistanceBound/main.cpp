...
/// \date February 2017.
///
/// \brief Command line program for PersistenceDiagramDistanceBound computation.
...
int main(int argc, char **argv) {
  ...
  ttk::Debug msg;
  msg.setDebugMsgPrefix("PersistenceDiagramDistanceBound");

  vtkNew<ttkPersistenceDiagramDistanceBound> ldist{};
  ...
  for(size_t i = 0; i < inputFilePaths.size(); i++) {
    ...
    if(listArrays) {
      ...
      ldist->SetInputDataObject(i, reader->GetOutput());
