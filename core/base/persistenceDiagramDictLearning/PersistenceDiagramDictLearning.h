/// \ingroup base
/// \class ttk::PersistenceDiagramDictLearning
...
///
/// \sa ttkPersistenceDiagramDictLearning
...
namespace ttk {
  ...
  class PersistenceDiagramDictLearning : virtual public Debug {

  public:
    PersistenceDiagramDictLearning() {
      this->setDebugMsgPrefix("PersistenceDiagramDictLearning");
    };
  ...
  template <class dataType>
  std::vector<int> PersistenceDiagramDictLearning::execute(
    std::vector<std::vector<diagramTuple>> &intermediateDiagrams,
