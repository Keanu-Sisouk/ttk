#include <ttkMacros.h>
#include <ttkPersistenceDiagramDictLearning.h>
#include <ttkUtils.h>
...
vtkStandardNewMacro(ttkPersistenceDiagramDictLearning);

ttkPersistenceDiagramDictLearning::ttkPersistenceDiagramDictLearning() {
  SetNumberOfInputPorts(1);
  SetNumberOfOutputPorts(3);
}

int ttkPersistenceDiagramDictLearning::FillInputPortInformation(
...
int ttkPersistenceDiagramDictLearning::FillOutputPortInformation(
  int port, vtkInformation *info) {
...
void ttkPersistenceDiagramDictLearning::Modified() {
  needUpdate_ = true;
  ttkAlgorithm::Modified();
}

int ttkPersistenceDiagramDictLearning::RequestData(
...
void ttkPersistenceDiagramDictLearning::VTUToDiagram(
...
void ttkPersistenceDiagramDictLearning::diagramToVTU(
...
void ttkPersistenceDiagramDictLearning::outputClusteredDiagrams(
...
void ttkPersistenceDiagramDictLearning::outputCentroids(
  vtkMultiBlockDataSet *output,
...
void ttkPersistenceDiagramDictLearning::outputMatchings(
  vtkMultiBlockDataSet *output,
