...
///
/// \sa PersistenceDiagramDictLearning
...
// VTK Module
#include <ttkPersistenceDiagramDictLearningModule.h>

// TTK includes
#include <PersistenceDiagramBarycenter.h>
#include <PersistenceDiagramDictLearning.h>
#include <ttkAlgorithm.h>
#include <ttkMacros.h>

class vtkUnstructuredGrid;

class TTKPERSISTENCEDIAGRAMDICTLEARNING_EXPORT ttkPersistenceDiagramDictLearning
  : public ttkAlgorithm,
    protected ttk::PersistenceDiagramDictLearning {

public:
  static ttkPersistenceDiagramDictLearning *New();

  vtkTypeMacro(ttkPersistenceDiagramDictLearning, ttkAlgorithm);
...
protected:
  ttkPersistenceDiagramDictLearning();
  ...
  void outputMatchings(vtkMultiBlockDataSet *output,
                       ...
                       const std::vector<int> &inv_clustering,
                       const ttkPersistenceDiagramDictLearning::DISPLAY dm,
                       const double spacing,
                       const double max_persistence) const;
