...
// VTK Module
#include <ttkWeightedBarycenterModule.h>
...
class TTKWEIGHTEDBARYCENTER_EXPORT ttkWeightedBarycenter
  : public ttkAlgorithm,
    protected ttk::PersistenceDiagramClustering {

public:
  static ttkWeightedBarycenter *New();

  vtkTypeMacro(ttkWeightedBarycenter, ttkAlgorithm);
...
protected:
  ...
  void outputMatchings(
    ...
    const std::vector<int> &inv_clustering,
    const ttkWeightedBarycenter::DISPLAY dm,
    const double spacing,
    const double max_persistence) const;
